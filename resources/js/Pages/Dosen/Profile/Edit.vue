...
/**
 * Avatar preview:
 * - kalau user pilih file -> tampil preview local (URL.createObjectURL)
 * - kalau batal / null -> balik ke stored avatar
 */
...
const anyDirty = computed(() => profileDirty.value || passwordDirty.value);
...
const submitProfile = () => {
    profileForm.post(route("dosen.profile.update"), {
        forceFormData: true,
        preserveScroll: true,
        onSuccess: () => {
...
const shownAvatar = computed(
    () => avatarPreview.value || storedAvatarUrl.value,
);
</script>
                ...
                <div class="flex items-start justify-between gap-4">
                    <div class="min-w-0">
                        ...
                        <p class="mt-1 text-sm text-gray-600">
                            Perbarui profil dosen dan keamanan akun.
                        </p>
                    </div>
