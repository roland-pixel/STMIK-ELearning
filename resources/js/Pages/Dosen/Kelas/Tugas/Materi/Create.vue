...
watch(
    () => form.link_url,
    () => {
        // kalau user isi link, error "file minimal salah satu" biasanya hilang
        if (String(form.link_url || "").trim().length) form.clearErrors("file");
    },
);

const submit = () => {
    form.post(route("dosen.kelas.materi.store", props.kelas.uuid), {
                            ...
                            >
                                ...
                                >
                                    <div>
                                        ...
                                        >
                                            Isi minimal salah satu: upload file
                                            atau link.
                                        </div>
                                    </div>
                    ...
                    >
                        ...
                        <ul class="mt-3 space-y-2 text-sm text-gray-600">
                            <li class="flex gap-2">
                                ...
                                Upload file (PDF/Doc/PPT) atau isi link Google
                                Drive.
                            </li>
                            <li class="flex gap-2">
                                <span class="text-gray-400">•</span>
