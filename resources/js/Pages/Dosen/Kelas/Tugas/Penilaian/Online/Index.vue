    ...
    <section class="w-full min-w-0">
        ...
        <div class="mx-auto max-w-6xl px-6 py-6">
            ...
            <div v-else class="space-y-3">
                <div v-for="p in penilaians" :key="p.id" class="rounded-2xl border transition" :class="openId === p.id
                    ...
                    <div class="px-5 py-4 flex items-center justify-between gap-4 cursor-pointer"
                        ...
                        <div class="flex items-center gap-4 min-w-0">
                            <div class="shrink-0">
                                <div class="w-10 h-10 rounded-full bg-gray-800 grid place-items-center text-white">
                            ...
                            <div class="min-w-0">
                                ...
                                <div class="mt-1 flex flex-wrap items-center gap-x-3 gap-y-1 text-xs text-gray-600">
                                    <span class="inline-flex items-center gap-1">
                                        <span class="opacity-60">Pertanyaan:</span>
                                        <b class="text-gray-900">{{
                                            getJumlahPertanyaan(p)
                                        }}</b>
                                    </span>
                                    <span class="inline-flex items-center gap-1">
                                        <span class="opacity-60">Total bobot:</span>
                                        <b class="text-gray-900">{{
                                            getTotalBobot(p)
                                        }}</b>
                                    </span>
                                    <span v-if="p.tenggat_waktu" class="inline-flex items-center gap-1">
                        ...
                        <div class="shrink-0 flex items-center gap-3">
                            ...
                            <div class="relative" data-row-menu @click.stop>
                                ...
                                <div v-if="openMenuId === p.id"
                                    ...
                                    <button type="button" class="w-full text-left px-4 py-3 text-sm hover:bg-gray-50"
                                        @click="goEdit(p)">
                                        Edit
                                    </button>
                                    <button type="button"
                        ...
                        <div class="rounded-2xl border border-gray-200 bg-white p-4">
                            <div class="flex items-start justify-between gap-3">
                                <div class="min-w-0">
                                    ...
                                    <div v-if="p.instruksi" class="mt-1 text-sm text-gray-700 whitespace-pre-line">
                                        {{ p.instruksi }}
                                    </div>
                                ...
                                <button v-if="props.with !== 'full'" type="button"
                            ...
                            <div class="mt-4">
                                <div class="text-xs font-bold tracking-wide text-gray-700 uppercase">
                                    Pertanyaan
                                </div>
                                ...
                                <div v-else class="mt-3 space-y-3">
                                    <div v-for="q in p.pertanyaans" :key="q.id"
                                        ...
                                        <div v-if="q.images && q.images.length" class="mt-3">
                                        ...
                                        <div v-if="shouldShowHint(q)" class="mt-3 text-xs text-gray-500">
