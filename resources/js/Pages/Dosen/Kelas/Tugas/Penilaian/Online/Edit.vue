...
const submit = () => {
    ...
    if (props.usedCategories.includes(form.kategori) && form.kategori !== 'tugas') {
        alert(`Maaf, penilaian untuk ${form.kategori.toUpperCase()} sudah dibuat sebelumnya.`);
        return;
    }
    form.clearErrors();
...
const filteredKategoriOptions = computed(() => {
    return props.kategoriOptions.filter(option => {
        ...
        // Sembunyikan jika kategori sudah ada di database
        ...
        <div class="mx-auto max-w-6xl px-6 py-6 space-y-6">
            ...
            <div class="rounded-2xl border border-gray-200 bg-white shadow-sm">
                ...
                <div class="p-5 space-y-5">
                    <div v-for="(q, i) in form.pertanyaans" :key="q.client_key"
                        ...
                        <div class="p-4">
                            ...
                            <!-- new previews -->
                            <div v-if="previews[q.client_key]?.length" class="mt-4">
                                <div class="text-[11px] font-bold tracking-wide text-gray-700 uppercase">
                                    Gambar baru (akan diupload)
                                </div>
                                <div class="mt-2 flex flex-wrap gap-3">
                                    <div v-for="(src, idx) in previews[
                                        q.client_key
                                    ]" :key="src"
                                        class="relative h-24 w-32 overflow-hidden rounded-xl border border-gray-200 bg-gray-50">
