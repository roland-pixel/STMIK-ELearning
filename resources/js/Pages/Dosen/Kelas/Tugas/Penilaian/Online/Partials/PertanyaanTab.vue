...
const loadFullIfNeeded = () => {
    ...
    const params = { kelas: props.kelas.uuid, with: "full", tab: "pertanyaan" };
...
<template>
    ...
    <div v-if="isEmpty" class="py-20 flex flex-col items-center text-center">
        ...
        <div class="mt-2 max-w-md text-sm text-gray-500">
            Klik tombol <b>Buat</b> untuk menambahkan penilaian online beserta
            pertanyaannya.
        </div>
    </div>
            ...
            <div v-if="openId === p.id" class="px-5 pb-5">
                <div class="rounded-2xl border border-gray-200 bg-white p-4">
                    ...
                    <div class="mt-4">
                        ...
                        <div
                            v-if="!p.pertanyaans || !p.pertanyaans.length"
                        ...
                        <div v-else class="mt-3 space-y-3">
                            ...
                            >
                                ...
                                >
                                    Detail opsi/gambar tampil setelah klik
                                    <b>Muat detail lengkap</b>.
                                </div>
                            </div>
                        </div>
                    </div>
