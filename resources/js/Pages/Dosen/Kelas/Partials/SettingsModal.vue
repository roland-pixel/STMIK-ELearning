    ...
    <div v-if="open" class="fixed inset-0 z-50">
        ...
        <div class="absolute inset-0 flex items-center justify-center p-4">
            <div
                ...
                <!-- header -->
                <div class="px-5 py-4 border-b border-gray-200/70 flex items-start justify-between gap-4 shrink-0">
                    <div class="min-w-0">
                    ...
                    <button class="shrink-0 w-10 h-10 rounded-2xl hover:bg-gray-100 grid place-items-center transition"
                        @click="emit('close')" type="button" aria-label="Tutup">
                        <span class="text-lg leading-none">✕</span>
                    </button>
                </div>

                <!-- FORM: wajib flex-col + min-h-0 biar body bisa overflow -->
                <form class="flex-1 min-h-0 flex flex-col" @submit.prevent="submit">
                    <!-- BODY (scrollable): wajib flex-1 + min-h-0 + overflow-y-auto -->
                    <div class="flex-1 min-h-0 overflow-y-auto overscroll-contain p-5 space-y-5">
                        <!-- info kelas -->
                        <div class="rounded-2xl border border-gray-200/70 bg-gray-50/60 p-4">
                            <div class="flex items-start justify-between gap-3">
                                ...
                                <div class="shrink-0 inline-flex items-center gap-2 rounded-xl bg-white px-3 py-2 ring-1 ring-gray-200/70"
                                    :class="totalOk
                                        ? 'text-emerald-700'
                                        : 'text-amber-700'
                            ...
                            <div v-if="!totalOk" class="mt-3 text-xs text-amber-700">
                        ...
                        <div>
                            ...
                            <div v-if="form.errors.nama_kelas" class="mt-2 text-xs text-red-600">
                        ...
                        <div>
                            ...
                            <div class="mt-2 flex items-stretch gap-2">
                                <div class="relative flex-1">
                                    <input v-model="form.kode_gabung"
                                ...
                                <button type="button"
                                    ...
                                    @click="shuffleKode" title="Buat kode gabung baru secara acak">
                                    Ganti &amp; Acak
                                </button>
                            </div>
                            ...
                            <div v-if="form.errors.kode_gabung" class="mt-2 text-xs text-red-600">
                        ...
                        <div>
                            ...
                            <div v-if="form.errors.deskripsi" class="mt-2 text-xs text-red-600">
                        ...
                        <div class="rounded-2xl border border-gray-200/70 p-4">
                            <div class="flex items-center justify-between gap-3">
                                ...
                                <div class="text-[11px] font-semibold px-2.5 py-1.5 rounded-xl" :class="totalOk
                            ...
                            <div class="mt-3 rounded-xl bg-blue-50/80 p-3 ring-1 ring-blue-200/50">
                                <div class="flex items-start gap-2">
                                    <span class="text-[14px]">ℹ️</span>
                                    <p class="text-[11px] leading-relaxed text-blue-800">
                                        Perubahan bobot akan menghitung ulang seluruh nilai mahasiswa di kelas ini.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="mt-4 grid grid-cols-3 gap-3">
                                <div class="rounded-2xl bg-gray-50 p-3 ring-1 ring-gray-200/70">
                                    <label class="text-[11px] font-semibold text-gray-700">Tugas (%)</label>
                                    <input v-model.number="form.persentase_tugas" type="number" min="0" max="100"
                                ...
                                <div class="rounded-2xl bg-gray-50 p-3 ring-1 ring-gray-200/70">
                                    <label class="text-[11px] font-semibold text-gray-700">UTS (%)</label>
                                    <input v-model.number="form.persentase_uts" type="number" min="0" max="100"
                                        class="mt-2 w-full rounded-xl border-2 border-gray-200 bg-white px-3 py-2 focus:border-gray-900 focus:ring-2 focus:ring-gray-900/10 hover:border-gray-300 transition" />
                                </div>

                                <div class="rounded-2xl bg-gray-50 p-3 ring-1 ring-gray-200/70">
                                    <label class="text-[11px] font-semibold text-gray-700">UAS (%)</label>
                                    <input v-model.number="form.persentase_uas" type="number" min="0" max="100"
                                        class="mt-2 w-full rounded-xl border-2 border-gray-200 bg-white px-3 py-2 focus:border-gray-900 focus:ring-2 focus:ring-gray-900/10 hover:border-gray-300 transition" />
                                </div>
                            </div>

                            <div v-if="form.errors.persentase_tugas" class="mt-3 text-xs text-red-600">
                    ...
                    <div
                        ...
                        <div class="flex items-center gap-3">
                            <div v-if="form.hasErrors" class="text-xs text-red-600">
