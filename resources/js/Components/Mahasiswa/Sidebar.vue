            ...
            <div class="flex-1 overflow-y-auto px-3 py-4">
                <div class="space-y-2">
                    <Link
                        ...
                        :class="navItemClass('mahasiswa.dashboard')"
                        @click="closeSidebar"
                    >
                    ...
                    <Link
                        :href="'#'"
                        @click.prevent
                        :class="navItemClass('mahasiswa.leaderboard.index')"
                        @click="closeSidebar"
                    >
                        <svg viewBox="0 0 24 24" class="w-5 h-5 opacity-80">
                            <path
                                fill="currentColor"
                                d="M7 21h10v-2H7v2zm5-18L7 8h3v6h4V8h3l-5-5z"
                            />
                        </svg>
                ...
                <div class="mt-6">
                    ...
                    >
                        ...
                        <svg
                            ...
                            :class="openTerdaftar ? 'rotate-180' : ''"
                        >
