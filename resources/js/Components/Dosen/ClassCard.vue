...
const chipClass = (tone) => {
    if (tone === "rose")
        return "bg-white/85 text-rose-700 ring-1 ring-white/40";
...
const detailHref = computed(() => {
    ...
    return route("dosen.kelas.show", uuid);
});
...
// potong untuk tampilan (biar stabil), full tetap bisa hover via title
const bodyDescShort = computed(() => {
    const t = bodyDesc.value ?? "";
...
<template>
    <Link
        :href="detailHref"
        class="block group focus:outline-none focus:ring-2 focus:ring-rose-700/20 rounded-2xl"
        preserve-scroll
    >
        <!-- ✅ KUNCI TINGGI + FLEX COLUMN -->
        <div
        ...
        >
            ...
            <div class="border-t border-gray-200/60 px-4 py-4 flex-1">
                <div class="flex items-start justify-between gap-3">
                    <div class="min-w-0">
                        ...
                        <div class="mt-0.5 text-sm font-semibold text-gray-800">
                            ...
                            <!-- Baris Author (selalu muncul kalau ada) -->
                            <p
                                v-if="
                ...
                <!-- ✅ Area progress juga dibuat stabil -->
                <div class="mt-4">
                    <div v-if="progress !== null">
                        ...
                        >
                            <div
                                class="h-full rounded-full bg-rose-600/80 transition-all duration-300 group-hover:bg-rose-600"
