...
<template>
    <header class="h-16 bg-white/90 backdrop-blur border-b border-gray-200/60 sticky top-0 z-40">
        <div class="h-full flex items-center justify-between px-4">
            ...
            <div class="flex items-center gap-3 min-w-0">
                <button type="button"
                    ...
                    aria-label="Menu" @click="emit('toggle-sidebar')">
                ...
                <div class="flex items-center gap-3 min-w-0">
                    <Link :href="route('dosen.dashboard')"
                        ...
                        <img :src="logoStmik" alt="Logo STMIK" class="w-full h-full object-contain p-1" />
                    </Link>
            ...
            <div class="flex items-center gap-2 relative">
                ...
                <div v-if="openProfile"
                    ...
                    <Link :href="route('dosen.profile.edit')"
                        class="block px-4 py-3 text-sm hover:bg-gray-50 transition" @click="closeProfile">
                        Edit Profil
                    </Link>
