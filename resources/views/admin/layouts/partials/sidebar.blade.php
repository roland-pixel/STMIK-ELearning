            ...
            <div class="mt-2 space-y-1">
                ...
                <a href="{{ route('admin.input_nilai_manual.index') }}"
                    ...
                    <span
                        ...
                        {{-- Calculator Icon --}}
                        <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none">
                            <path d="M9 7h6m0 0v6m0-6l-3 3m3-3l3 3M4 21V5a2 2 0 012-2h12a2 2 0 012 2v16m-9-10h4"
                ...
                <a href="{{ route('admin.bimbingans.index') }}"
                    ...
                    <span
                        ...
                        <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none">
                            <path
                                d="M17 8h2a2 2 0 012 2v6a2 2 0 01-2 2h-2v4l-4-4H9a1.994 1.994 0 01-1.414-.586m0 0L11 14h0a1.994 1.994 0 011.414 0l.375.375"
                                stroke="currentColor" stroke-width="1.8" stroke-linecap="round"
                                stroke-linejoin="round" />
                        </svg>
                    </span>
                ...
                <a href="{{ route('admin.khs.index') }}"
                    class="flex items-center gap-3 px-3 py-2.5 rounded-2xl transition {{ navItemClass(['admin.khs.*']) }}">
                    <span
                        class="w-9 h-9 rounded-xl border flex items-center justify-center {{ navIconWrapClass(['admin.khs.*']) }}">
                        {{-- File Text Icon --}}
                        <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none">
                            <path
                    ...
                    <span class="{{ navLabelClass(['admin.khs.*']) }}">Kelola KHS</span>
                </a>

                {{-- Transkrip --}}
                <a href="{{ route('admin.transkrip.index') }}"
                    class="flex items-center gap-3 px-3 py-2.5 rounded-2xl transition {{ navItemClass(['admin.transkrip.*']) }}">
                    <span
