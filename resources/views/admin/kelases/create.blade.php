                        ...
                        <div class="mt-4 grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <select name="mata_kuliah_id" required
                                    class="mt-1 w-full rounded-xl border border-slate-300 bg-white px-3 py-2 text-sm
                                           focus:outline-none focus:ring-4 focus:ring-maroon-600/10 focus:border-maroon-700 transition">
                                    <option value="" disabled {{ old('mata_kuliah_id') ? '' : 'selected' }}>Pilih mata
                                        kuliah</option>
                            ...
                            <div>
                                ...
                                <select name="semester_id" required
                                    class="mt-1 w-full rounded-xl border border-slate-300 bg-white px-3 py-2 text-sm
                                           focus:outline-none focus:ring-4 focus:ring-maroon-600/10 focus:border-maroon-700 transition">
                                    <option value="" disabled {{ old('semester_id') ? '' : 'selected' }}>Pilih
                                        semester</option>
                    ...
                    <div>
                        ...
                        <div class="mt-4">
                            ...
                            <textarea name="deskripsi" rows="3" placeholder="Deskripsi singkat kelas..."
                                class="mt-1 w-full rounded-xl border border-slate-300 bg-white px-3 py-2 text-sm
                                       focus:outline-none focus:ring-4 focus:ring-maroon-600/10 focus:border-maroon-700 transition">{{ old('deskripsi') }}</textarea>
                            @error('deskripsi')
                                <p class="mt-1 text-sm text-rose-700">{{ $message }}</p>
                            @enderror
                        </div>
