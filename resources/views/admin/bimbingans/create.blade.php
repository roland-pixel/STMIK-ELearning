...
@section('content')
    ...
    <div class="max-w-3xl mx-auto space-y-4">
        ...
        {{-- Alert error (optional tapi bagus) --}}
        @if ($errors->any())
                ...
                <div class="flex items-start justify-between gap-4">
                    <div>
                        ...
                        <p class="text-sm text-ink-500 mt-1">
                            Pilih semester, MK spesial, mahasiswa, dan dosen pembimbing.
                        </p>
                    </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select name="semester_id"
                                ...
                                required>
                                <option value="" disabled {{ old('semester_id') ? '' : 'selected' }}>Pilih semester
                                </option>
                        ...
                        <div>
                            ...
                            <select name="mahasiswa_id"
                                class="mt-1 w-full rounded-xl border border-slate-300 bg-white px-3 py-2 text-sm
                                       focus:outline-none focus:ring-4 focus:ring-maroon-600/10 focus:border-maroon-700 transition"
                                required>
                                <option value="" disabled {{ old('mahasiswa_id') ? '' : 'selected' }}>Pilih mahasiswa
                                </option>
                        ...
                        <div>
                            ...
                            <select name="dosen_pembimbing_id"
                                class="mt-1 w-full rounded-xl border border-slate-300 bg-white px-3 py-2 text-sm
                                       focus:outline-none focus:ring-4 focus:ring-maroon-600/10 focus:border-maroon-700 transition"
                                required>
                                <option value="" disabled {{ old('dosen_pembimbing_id') ? '' : 'selected' }}>Pilih
                                    dosen</option>
                                @foreach ($dosens as $d)
                                    <option value="{{ $d->id }}"
        ...
        <p class="text-xs text-ink-400 text-center">
            Judul penelitian, nilai, dan status akan diisi oleh dosen pembimbing.
        </p>
    </div>
@endsection
