...
@section('title', 'Tambah Jurusan - Maroon Sneat Style')
@section('page_title', 'Tambah Jurusan')
@section('page_desc', 'Tambahkan data jurusan baru')
...
@section('content')
    ...
    <div class="max-w-3xl mx-auto space-y-4">
        ...
        <div class="rounded-2xl border border-slate-200 bg-white shadow-soft">
            <div class="p-6 sm:p-7">
                <div class="flex items-start justify-between gap-4">
                    <div>
                        <h2 class="text-lg font-semibold text-ink-900">Form Jurusan</h2>
                ...
                <form method="POST" action="{{ route('admin.jurusans.store') }}" class="mt-6 space-y-5">
                    @csrf
                        ...
                        <div>
                            ...
                            <select name="jenjang"
                                class="mt-1 w-full rounded-xl border border-slate-300 bg-white px-3 py-2 text-sm
                                       focus:outline-none focus:ring-4 focus:ring-maroon-600/10 focus:border-maroon-700 transition"
                                required>
                                <option value="" disabled {{ old('jenjang') ? '' : 'selected' }}>Pilih jenjang
                                </option>
        ...
        <p class="text-xs text-ink-400 text-center">
            Pastikan kode jurusan unik dan sesuai aturan kampus.
        </p>
    </div>
@endsection
