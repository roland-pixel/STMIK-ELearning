...
@section('title', 'Kelola Jurusan - Maroon Sneat Style')
@section('page_title', 'Kelola Jurusan')
@section('page_desc', 'Tambah, cari, dan ubah data jurusan')
    ...
    <div class="space-y-4 max-w-full">
        ...
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <form method="GET" class="flex gap-2 w-full sm:w-auto">
                <input type="text" name="q" value="{{ $q }}" placeholder="Cari kode/nama/jenjang..."
                            ...
                            <tr class="hover:bg-maroon-50/40 transition-colors">
                                ...
                                <td class="px-4 py-3 text-right">
                                    <div class="inline-flex items-center gap-2 whitespace-nowrap">
                                        {{-- Edit --}}
                                        <a href="{{ route('admin.jurusans.edit', $item) }}"
                                        ...
                                        {{-- Hapus --}}
                                        <button type="button"
                                            onclick="document.getElementById('hapus-jurusan-{{ $item->id }}').showModal()"
                                    ...
                                    <dialog id="hapus-jurusan-{{ $item->id }}"
                                        ...
                                        <div
                                            ...
                                            <div class="flex items-start gap-3">
                                                ...
                                                <div class="flex-1 text-left">
                                                    ...
                                                    <p class="mt-1 text-sm text-slate-600">
                                                        ...
                                                        <span
                                                            class="font-medium text-slate-900">{{ $item->kode_jurusan }}</span>
                                                        — {{ $item->nama_jurusan }} ({{ $item->jenjang }}).
                                            ...
                                            <div class="mt-5 flex justify-end gap-2">
                                                ...
                                                <form method="POST" action="{{ route('admin.jurusans.destroy', $item) }}">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit"
